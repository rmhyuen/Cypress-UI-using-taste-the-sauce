...
// Can be used to cache anything the browser can store.
...
describe('sorting', () => {
  // This format is only supported in typescript
  // before(("testIsloation", false) => {
  beforeEach(() => {
    //For some reason, it says this option is not supported in the current version of Cypress
